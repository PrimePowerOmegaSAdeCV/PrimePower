...
class CRMClaim(models.Model):
    ...
    # bateria
    nivel_electrolito = fields.Selection(string="Nivel Electrolito", selection=[('0', 'Correcto'), ('1', 'Bajo'),('2', 'Alto') ] )
    tipo_carga = fields.Selection(string="Tipo de carga", selection=[('0', 'Convencional'), ('1', 'Oportunidad'),('2', 'Carga rapida') ] )
    frecuencia_hidratacion = fields.Selection(string="Frecuencia Hidratación", selection=[('0', 'Nula'), ('1', 'Semanal'),('2', 'Mensual') ] )
    voltaje_celda = fields.Char(string="Voltaje diferente en alguna celda (Valor)", required=False, )
    voltaje_finalizar = fields.Char(string="Voltaje al finalizar la carga", required=False, )
    celda = fields.Char(string="Celda", required=False, )
    voltaje = fields.Char(string="Voltaje", required=False, )
    bateria_no_trabaja = fields.Boolean(string="Después de que la batería se encuentre bien cargada, la batería no trabaja 6 horas o más",  )
    mal_olor = fields.Boolean(string="Genera un Mal olor",  )
    bateria_caliente = fields.Boolean(string="La bateria se siente muy caliente", )
    fuga_bateria = fields.Boolean(string="Existe una fuga de electrolito que sale de la bateria", )
    otro_bateria = fields.Boolean(string="Otro (Descripción completa a detalle)", )
    otro_bateria_desc = fields.Text(string="Descripcion", required=False, )
    # cargador
    parametro_carga = fields.Char(string="Parametro de carga", required=False, )
    no_celdas = fields.Boolean(string="No. Celdas",  )
    amp = fields.Boolean(string="AMP", )
    curva = fields.Boolean(string="Curvas", )
    alimentacion_correcta = fields.Boolean(string="Alimentación correcta vs. Valores Cargador" , )
    codigo_falla = fields.Char(string="Código de falla", required=False, )
    leyenda_falla = fields.Char(string="Leyenda falla", required=False, )
    no_enciende = fields.Boolean(string="No enciende",  )
    otro_cargador = fields.Boolean(string="Otro", )
    otro_cargador_desc = fields.Text(string="Descripcion", required=False, )
